  ...
  return (
    <>
      ...
      <main className={`flex-col justify-between p-5 mx-auto  bg-base`}>
        ...
        <footer className="flex flex-row font-sans justify-center text-2xl text-blue hover:text-mauve items-center bottom-5">
          <Link href="/smiting/step2" className="underline underline-offset-2 outline-none">
